...
$(document).ready(function() {
  ...
  //LEVEL 4 BUTTONS:
  $("#quest4-1").click(function() {
    $("#question4-0").hide();
    $("#question5-0").show();
  });

  $("#quest4-2").click(function() {
    $("#question4-0").hide();
    $("#question5-1").show();
  });

  $("#quest4-3").click(function() {
    $("#question4-1").hide();
    $("#question5-3").show();
  });

  $("#quest4-4").click(function() {
    $("#question4-1").hide();
    $("#question5-2").show();
  });

  $("#quest4-5").click(function() {
    $("#question4-2").hide();
    $("#question5-5").show();
  });

  $("#quest4-6").click(function() {
    $("#question4-2").hide();
    $("#question5-4").show();
  });

  $("#quest4-7").click(function() {
    $("#question4-3").hide();
    $("#question5-6").show();
  });

  $("#quest4-8").click(function() {
    $("#question4-3").hide();
    $("#question5-7").show();
  });

  $("#quest4-9").click(function() {
    $("#question4-4").hide();
    $("#question5-8").show();
  });

  $("#quest4-10").click(function() {
    $("#question4-4").hide();
    $("#question5-9").show();
  });

  $("#quest4-11").click(function() {
    $("#question4-5").hide();
    $("#question5-11").show();
  });

  $("#quest4-12").click(function() {
    $("#question4-5").hide();
    $("#question5-10").show();
  });

  $("#quest4-13").click(function() {
    $("#question4-6").hide();
    $("#question5-12").show();
  });
  $("#quest4-14").click(function() {
    $("#question4-6").hide();
    $("#question5-13").show();
  });

  $("#quest4-15").click(function() {
    $("#question4-7").hide();
    $("#question5-15").show();
  });

  $("#quest4-16").click(function() {
    $("#question4-7").hide();
    $("#question5-14").show();
  });

  $("#quest4-17").click(function() {
    $("#question4-8").hide();
    $("#question5-17").show();
  });

  $("#quest4-18").click(function() {
    $("#question4-8").hide();
    $("#question5-16").show();
  });

  $("#quest4-19").click(function() {
    $("#question4-9").hide();
    $("#question5-19").show();
  });

  $("#quest4-20").click(function() {
    $("#question4-9").hide();
    $("#question5-18").show();
  });
  ...
  $("#quest4-23").click(function() {
    $("#question4-11").hide();
    $("#question5-23").show();
  });

  $("#quest4-24").click(function() {
    $("#question4-11").hide();
    $("#question5-22").show();
  });

  $("#quest4-25").click(function() {
    $("#question4-12").hide();
    $("#question5-24").show();
  });

  $("#quest4-26").click(function() {
    $("#question4-12").hide();
    $("#question5-25").show();
  });

  $("#quest4-27").click(function() {
    $("#question4-13").hide();
    $("#question5-27").show();
  });

  $("#quest4-28").click(function() {
    $("#question4-13").hide();
    $("#question5-26").show();
  });

  $("#quest4-29").click(function() {
    $("#question4-14").hide();
    $("#question5-29").show();
  });

  $("#quest4-30").click(function() {
    $("#question4-14").hide();
    $("#question5-28").show();
  });

  $("#quest4-31").click(function() {
    $("#question4-15").hide();
    $("#question5-31").show();
  });

  $("#quest4-32").click(function() {
    $("#question4-15").hide();
    $("#question5-30").show();
  });
